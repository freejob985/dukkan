...
class AffiliateController extends Controller
{
    ...
    public function myaffilateorders() {

        if(Auth::check()){

        $orders = Sendcart::where('sender_id', '=', Auth::user()->id)->get();
 ...
 return view('affiliate.frontend.orders', compact('orders', 'productscount'));
    ...
    public function getsingleorder($id){
        ...
        $order = Sendcart::findOrFail($id);

        return view('affiliate.singleorder', compact('order'));
