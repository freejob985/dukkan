...
class HomeController extends Controller
{
    ...
    public function prescription (){
       ...
       $pres = Uploadpres::latest()->get();

       return view('prescription.index', compact('pres'));
    }


    public function updatepreStatus(Request $request){

        $pre = Uploadpres::findOrFail($request->id);
    ...
    public function prescriptiondelete($id){
         ...
         Uploadpres::findOrFail($id)->delete();

         flash(translate('Prescription  Deleted'))->success();
    ...
    public function doctor($id)
    {
        ...
        if($user->has('affiliate_user')){

            return view('frontend.doctor', compact('user'));

        }else{

            flash(translate('Sorry This User Is Not A Doctor'))->error();
    ...
    public function uploadprescription(Request $request){
        ...
        if(!Auth::check()){
            ...
            flash(translate('Sorry You Need To Login First'))->error();
        ...
        $request->validate([
            ...
            'prescription' => 'mimes:jpeg,jpg,png,pdf|required|max:10000'
        ]);
       ...
       if($file){
            ...
            $fileName = uniqid() . '_mokhtar_ali_.' . $fileName;
    ...
    public function index()
    {
      ...
      $nn = Language::where('code', '=', $lang)->first()->rtl;
