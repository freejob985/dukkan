...
Route::get('/affiliate/myaffilateorders', 'AffiliateController@myaffilateorders')->name('affiliate.myaffilateorders');
...
Route::get('/affiliate/getsingleorder/{id}', 'AffiliateController@getsingleorder')->name('affiliate.getsingleorder');
