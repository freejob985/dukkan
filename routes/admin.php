...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
	...
	Route::get('prescriptiondelete/{id}','HomeController@prescriptiondelete')->name('prescriptiondelete');
	...
	Route::post('/pres/status', 'HomeController@updatepreStatus')->name('pres.status');
});
