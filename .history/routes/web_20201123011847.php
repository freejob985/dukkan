...
Route::get('/doctor/{id}', 'HomeController@doctor')->name('doctor');
Route::post('/uploadprescription', 'HomeController@uploadprescription')->name('uploadprescription');
...
Route::get('/getUserSendCart/{id}', 'CheckoutController@getUserSendCart')->name('getUserSendCart');


Route::post('sendcartbyemail', 'CheckoutController@sendcartbyemail')->name('sendcartbyemail');
Route::post('sendcartbywhatsapp', 'CheckoutController@sendcartbywhatsapp')->name('sendcartbywhatsapp');
